...
from tomtom_apis.automotive.models import FuelPricesParams, FuelPricesResponse
...
@pytest.mark.parametrize("json_response", ["automotive/get_fuel_price.json"], indirect=True)
async def test_deserialization_get_fuel_price(fuel_prizes_api: FuelPricesApi) -> None:
    """Test the get_fuel_price method."""
    response = await fuel_prizes_api.get_fuel_price(params=FuelPricesParams(fuelPrice="1:2622f89a-6300-11ec-8d12-a0423f39b5a2"))
